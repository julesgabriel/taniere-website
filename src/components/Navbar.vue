...
export default {
  ...
  computed: {
    deviceHeight() {
      return window.innerWidth < 810 ? "height: " + window.innerHeight + "px" : ""
    }
  },
  methods: {
    ...
    changeIndicatorColorAccordingToRouteContext() {
      this.$route.name === "singleArticle" ? this.indicatorclass = "background: #FECC50" : this.indicatorclass = "background: #FFFFFF"
    }
  },
  watch: {
    open: function (val) {
